    ...
    <div>
        <div class="grid grid-cols-5 gap-3">
            <div class="col-span-3">
                <h1 class="p-7 bg-slate-200 mb-8">
                    Mexican Shredded Chicken (Instant Pot + Crock Pot)
                </h1>
                <div>
                    <ButtonShare
                        :link="'mexican-shredded-chicken-instant-pot-crock-pot/'"
                    />
                    <div class="text-center mt-5">
                        <a
                            class="px-2 py-1 bg-black text-white mr-3"
                            href="#recipes"
                        >
                            <font-awesome-icon icon="fa-solid fa-down-long" />
                            Chuyển đến công thức
                        </a>
                        <button class="px-2 py-1 bg-black text-white">
                    ...
                    <div>
                        <div class="float-left">
                            <img
                                src="https://ketoinpearls.com/wp-content/uploads/2020/08/MG_9388-1024x1536.jpg.webp"
                                alt=""
                                class="p-7"
                            />
                        </div>
                        <p class="clear-both">
                            Gà xé Mexico theo phong cách nhà hàng sạch sẽ, không
                            có sữa, keto và ít carb. Không có gói, chất bảo
                            quản, hoặc rác! Bắt chước nhà hàng Mexico yêu thích
                            của bạn với món gà xé Mexico dễ dàng và sạch sẽ này.
                            Bạn đã bao giờ muốn tái tạo món gà xé Mexico theo
                            phong cách nhà hàng yêu thích của mình tại nhà chưa?
                            Vâng, bây giờ bạn có thể với công thức dễ dàng và
                            sạch sẽ này! Gia đình tôi là những người hâm mộ đồ
                            ăn Mexico. Trên thực tế, đây có lẽ là danh mục công
                            thức nấu ăn lớn nhất trên trang web của tôi vì tôi
                            chỉ yêu thích hương vị hoặc ẩm thực Mexico. Tôi thậm
                            chí đã nói đùa (nhưng nghiêm túc) về việc mua một
                            ngôi nhà nghỉ dưỡng ở Mexico vào một ngày nào đó.
                            Điều gì có thể tốt hơn đại dương và tacos? Ước mơ
                            lớn, phải không? Mặc dù tôi đã có một số công thức
                            nấu gà Mexico, nhưng tôi không có công thức cơ bản
                            “kiểu nhà hàng”. Và đó chính xác là công thức gà xé
                            Mexico này. Bạn có thể sử dụng món gà xé Mexico này
                            làm cơ sở cho bất cứ thứ gì mà trái tim nấu ăn sáng
                            tạo của bạn gợi lên.
                        </p>
                        <div>
                            <h1>Đây là công thức gà xé Mexico ngon nhất</h1>
                            <ul class="list-disc ml-10">
                                <li>
                                    Hương vị giống như gà nhà của nhà hàng
                                    Mexico yêu thích của bạn
                                </li>
                                <li>
                                    Hương vị giống như gà nhà của nhà hàng
                                    Mexico yêu thích của bạn
                        ...
                        <div>
                            <h1>Cách Làm Gà Xé Mexico Sạch Tại Nhà</h1>
                            <ul>
                                <li>
                                    Công thức gà xé Mexico dễ dàng này có thể
                                    được thực hiện cực nhanh bằng cách sử dụng
                                    Instant Pot của bạn nhưng nếu bạn muốn đặt
                                    nó và quên nó đi, bạn cũng có thể sử dụng
                                    nồi nấu chậm của mình .
                                </li>
                                <li>
                                    Công thức gà xé Mexico dễ dàng này có thể
                                    được thực hiện cực nhanh bằng cách sử dụng
                        ...
                        <div class="my-5">
                            ...
                            <ul class="list-disc ml-10">
                                <li>
                                    ...
                                    >
                                        Instant Pot Keto Adobo Chicken (dairy
                                        free, paleo, Whole30)
                                    </a>
                                </li>
                                <li>
                                    <a
                                        ...
                                        class="underline hover:opacity-80"
                                    >
                                        Ground Chicken Tacos (keto, paleo, dairy
                                        free, Whole30)
                                    </a>
                                </li>
                                <li>
                        ...
                        <div
                            class="border border-slate-400 border-solid p-2"
                            id="recipes"
                        >
                            <div class="flex">
                                <div>
                                    <h2
                                        class="font-bold text-[#000000] text-[1.8em]"
                                    >
                                        Gà xé Mexico (Nồi ăn liền + Nồi hầm)
                                    </h2>
                                    <span
                                        class="block text-black font-light text-lg mb-2"
                                    >
                                        Anna Hunley | Keto trong ngọc trai
                                    </span>
                                    <p class="text-lg">
                                        Gà xé Mexico theo phong cách nhà hàng có
                                        thể được dùng trong món tacos,
                                        enchiladas, salad, v.v.!
                                    </p>
                                </div>
                                <div>
                                    <img
                            ...
                            <div
                                class="mt-5 flex items-center justify-center mb-10"
                            >
                                <router-link
                                    to="/printRecipes"
                                    class="px-20 py-2 text-white mr-3 bg-[#5A822B] rounded"
                                >
                                    <font-awesome-icon
                                ...
                                <button
                                    class="px-20 py-2 border-solid border-[1px] border-black rounded text-black mr-3"
                                >
                                    <font-awesome-icon
                            ...
                            <div class="flex flex-wrap justify-around">
                                <div class="flex-auto">
                                    <div
                                        class="text-[24px] flex flex-wrap items-center"
                                    >
                                        <span
                            ...
                            <!-- <div
                                class="flex items-center justify-around text-center"
                            >
                            ...
                            <div class="mb-5">
                                <div class="flex items-center">
                                    <h2 class="text-black mr-3 font-bold">
                                        INGREDIENTS
                                    </h2>
                                    <span
                                        class="flex-auto h-[1px] border-b-solid border-b-[1px] border-b-[#e0e0e0]"
                                ...
                                <ul class="ml-14">
                                    <li style="list-style-type: decimal">
                                        <div style="margin-bottom: 5px">
                                            Add the water, chicken, and lime
                                            juice to the pot.
                                        </div>
                                    </li>
                                    <li style="list-style-type: decimal">
                                        <div style="margin-bottom: 5px">
                                            Sprinkle spices on top of the
                                            chicken.
                                        </div>
                                    </li>
                                    <li style="list-style-type: decimal">
                                    ...
                                    <li style="list-style-type: decimal">
                                        <div style="margin-bottom: 5px">
                                            Add tomatoes to the top. Do NOT
                                            stir.
                                        </div>
                                    </li>
                                    <li style="list-style-type: decimal">
                                        <div style="margin-bottom: 5px">
                                            ...
                                            Cook on HIGH pressure for 15
                                            minutes. Manually (naturally)
                                            release the steam.
                                        </div>
                                    </li>
                                    <li style="list-style-type: decimal">
                                        <div style="margin-bottom: 5px">
                                            Remove the chicken to a cutting
                                            board. Shred with two forks and
                                            return to juices until ready to use
                                            or serve.
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="ml-12 text-[#333]">
                                    <span
                                        style="
                                            ...
                                            margin-bottom: 10px;
                                        "
                                        >Crockpot: add all ingredients to the
                                        slow cooker. Cook on low for 5 hours or
                                        high for 3 hours.</span
                                    >
                                    ...
                                    <span
                                        style="
                                            ...
                                            margin-bottom: 10px;
                                        "
                                        >Store leftovers in the refrigerator up
                                        to 1 week in an airtight container.
                                        Freeze leftovers in a freezer safe bag
                                        up to 6 months. Thaw in the refrigerator
                                        when ready to use.</span
                                    >

                                    <span
                                        style="display: block; margin-bottom;: 10px"
                                        ><span><span>Yield:</span>&nbsp;6</span
                                        >&nbsp;<span
                                            ><span>Serving Size:</span
                                            >&nbsp;1</span
                                        ><br /><span
                                            ><em>Amount Per Serving:</em></span
                                        >&nbsp;<span
                                            ><span>Calories:</span
                                            >&nbsp;119</span
                                        ><span
                            ...
                            <div>
                                ...
                                <div
                                    class="flex flex-wrap text-[0.9rem] text-center"
                                >
                                    <span class="px-3"> Serving: 1g </span>
                                    <span class="px-3">
                                        Calories: 119kcal
                                    </span>
                                    <span class="px-3">
                                    ...
                                    <span class="px-3"> Protein: 22.1g </span>
                                    <span class="px-3"> Fat: 0.6g </span>
                                    <span class="px-3"> Fiber: 1.1g </span>
                                    <span class="px-3">
                                        Saturated Fat: 6g
                                    </span>
                                    <span class="px-3">
                                        Polyunsaturated Fat: 1g</span
                                    >
                                    <span class="px-3">
                                        Monounsaturated Fat: 1g</span
                                    >
                                    <span class="px-3">
                                        Cholesterol: 0.2mg</span
                                    >
                                    <span class="px-3">Sodium: 26mg</span>
                                    <span class="px-3"> Potassium: 29mg</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
import ButtonShare from "../../ButtonShare/index.vue";
import FollowMe from "../../Follow/index.vue";
